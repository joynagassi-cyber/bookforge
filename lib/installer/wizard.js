...
${C.bold}${C.cyan}║                                                                  ║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}██████╗ ${C.reset}${C.brightCyan}██╗   ██╗${C.reset}${C.brightCyan}███████╗${C.reset}${C.brightCyan}████████╗${C.reset}${C.brightCyan}███████╗${C.reset}${C.brightCyan}███╗   ██╗${C.reset}  ${C.gray}v${versionStr}${C.reset}  ${C.bold}${C.cyan}║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}██╔══██╗${C.reset}${C.brightCyan}██║   ██║${C.reset}${C.brightCyan}██╔════╝${C.reset}${C.brightCyan}╚══██╔══╝${C.reset}${C.brightCyan}██╔════╝${C.reset}${C.brightCyan}████╗  ██║${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}██████╔╝${C.reset}${C.brightCyan}██║   ██║${C.reset}${C.brightCyan}███████╗${C.reset}   ${C.brightCyan}██║${C.reset}   ${C.brightCyan}███████╗${C.reset}${C.brightCyan}██╔██╗ ██║${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}██╔══██╗${C.reset}${C.brightCyan}██║   ██║${C.reset}${C.brightCyan}╚════██║${C.reset}   ${C.brightCyan}██║${C.reset}   ${C.brightCyan}╚════██║${C.reset}${C.brightCyan}██║╚██╗██║${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}██║  ██║${C.reset}${C.brightCyan}╚██████╔╝${C.reset}${C.brightCyan}███████║${C.reset}   ${C.brightCyan}██║${C.reset}   ${C.brightCyan}███████║${C.reset}${C.brightCyan}██║ ╚████║${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}║${C.reset}
${C.bold}${C.cyan}║${C.reset}  ${C.bold}${C.brightCyan}╚═╝  ╚═╝${C.reset}${C.brightCyan} ╚═════╝ ${C.reset}${C.brightCyan}╚══════╝${C.reset}   ${C.brightCyan}╚═╝${C.reset}   ${C.brightCyan}╚══════╝${C.reset}${C.brightCyan}╚═╝  ╚═══╝${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}║${C.reset}
...
function printProgressBar() {
  ...
  console.log(`  ${C.gray}├${'─'.repeat(50)}${C.gray}┤${C.reset}`);
...
function printStepHeader(title, subtitle) {
  console.log(`${C.bold}${C.cyan}┌${'─'.repeat(60)}${C.gray}┐${C.reset}`);
  console.log(`${C.gray}│${C.reset} ${C.bold}${C.cyan} ${title.padEnd(59)} ${C.gray}│${C.reset}`);
  console.log(`${C.gray}├${'─'.repeat(60)}${C.gray}┤${C.reset}`);
  console.log(`${C.gray}│${C.reset} ${C.dim}${subtitle.padEnd(59)} ${C.gray}│${C.reset}`);
  console.log(`${C.gray}└${'─'.repeat(60)}${C.gray}┘${C.reset}\n`);
}
...
function printInfoBox(title, lines) {
  ...
  console.log(`${C.gray}│${C.reset} ${C.bold}${C.blue} ${title}${C.gray} ${' '.repeat(width - title.length - 2)}${C.gray}│${C.reset}`);
  console.log(`${C.gray}├${'─'.repeat(width)}${C.gray}┤${C.reset}`);
  for (const line of lines) {
    const padded = line.padEnd(width - 2);
    console.log(`${C.gray}│${C.reset} ${C.gray}${padded}${C.gray}│${C.reset}`);
  }
  console.log(`${C.gray}└${'─'.repeat(width)}${C.gray}┘${C.reset}\n`);
}
...
function printHelpBox() {
  ...
  │    • Press ${C.yellow}Enter${C.reset} to accept default                          │
  │    • Type a value and press ${C.yellow}Enter${C.reset} to continue              │
  │    • Press ${C.red}Ctrl+C${C.reset} to cancel at any time                   │
  └─────────────────────────────────────────────────────────────┘
${C.reset}`);
}
