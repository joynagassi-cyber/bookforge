 ...
 * Inspired by BMAD methodology with modern ASCII art UI
 */
...
${C.bold}${C.cyan}|                                                                      |${C.reset}
${C.bold}${C.cyan}|${C.reset}  ${C.bold}${C.brightCyan} _____  ${C.reset}${C.brightCyan}/ _  / ${C.reset}${C.brightCyan}/ ___ / ${C.reset}${C.brightCyan}/  _____/ ${C.reset}${C.brightCyan}/ ___ / ${C.reset}${C.brightCyan}/ _  /${C.reset}  ${C.gray}v${versionStr}${C.reset}  ${C.bold}${C.cyan}|${C.reset}
${C.bold}${C.cyan}|${C.reset}  ${C.bold}${C.brightCyan}/  _  / ${C.reset}${C.brightCyan}/ /_/ / ${C.reset}${C.brightCyan}/ /_/ / ${C.reset}${C.brightCyan}/ /_/ / ${C.reset}${C.brightCyan}/ /_/ / ${C.reset}${C.brightCyan}/ /_/ /${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}|${C.reset}
${C.bold}${C.cyan}|${C.reset}  ${C.bold}${C.brightCyan}/  _  / ${C.reset}${C.brightCyan}/ ___ / ${C.reset}${C.brightCyan}/ ___ / ${C.reset}${C.brightCyan}/  __/  ${C.reset}${C.brightCyan}/  ___ / ${C.reset}${C.brightCyan}/  _  /${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}|${C.reset}
${C.bold}${C.cyan}|${C.reset}  ${C.bold}${C.brightCyan}/_/ |_|/${C.reset}${C.brightCyan}/ /   / ${C.reset}${C.brightCyan}/ /   / ${C.reset}${C.brightCyan}/ /     ${C.reset}${C.brightCyan}/ /   / ${C.reset}${C.brightCyan}/_/ |_|${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}|${C.reset}
${C.bold}${C.cyan}|${C.reset}  ${C.bold}${C.brightCyan}/_____/${C.reset}${C.brightCyan}/_/   / ${C.reset}${C.brightCyan}/_/   / ${C.reset}${C.brightCyan}/_/     ${C.reset}${C.brightCyan}/_/   / ${C.reset}${C.brightCyan}/_____/ ${C.reset}  ${C.gray}         ${C.reset}  ${C.bold}${C.cyan}|${C.reset}
...
${C.bold}${C.cyan}|${C.reset}   ${C.dim}Build More, Write Smarter · © BookForge${C.reset}                           ${C.gray}|${C.reset}
${C.bold}${C.cyan}|${C.reset}                                                                      ${C.gray}|${C.reset}
${C.bold}${C.cyan}+======================================================================+${C.reset}
`;
  console.log(banner);
