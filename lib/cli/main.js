...
import { initProject, status, validate, doctor } from '../installer/installer.js';

const projectDir = (args) => {
  const pos = args.filter(x => !x.startsWith('--') && x !== 'status' && x !== 'validate' && x !== 'doctor' && x !== 'install' && x !== 'init');
