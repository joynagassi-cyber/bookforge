...
export async function main(args) {
  ...
  switch (cmd) {
    ...
    case 'validate': {
      ...
      const configPath = fs.existsSync(path.join(validateProject, 'bookforge', 'bookforge-config', 'config.yaml'))
    ...
    case 'doctor': {
      ...
      const checks = [
        ...
        { name: 'Configuration', check: () => fs.existsSync(path.join(doctorProject, 'bookforge', 'config.yaml')) || fs.existsSync(path.join(doctorProject, 'bookforge', 'bookforge-config', 'config.yaml')) },
