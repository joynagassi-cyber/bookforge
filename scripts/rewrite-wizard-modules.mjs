...
const content = fs.readFileSync('lib/installer/wizard.js', 'utf8');
...
if (stepAgentsStart !== -1 && stepSkillsEnd !== -1) {
  ...
  const newContent = before + newStepModules + after;
  fs.writeFileSync('lib/installer/wizard.js', newContent);
